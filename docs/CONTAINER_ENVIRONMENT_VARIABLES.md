...
| `CURRENCY_API_BASE_URL` | Base URL of the external currency-rate provider. Defaults to the unauthenticated open-source Frankfurter endpoint. | `"https://frankfurter.dev"` |
